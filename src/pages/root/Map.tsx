...
import maplibregl, { Map as MaplibreMap, MapGeoJSONFeature } from 'maplibre-gl'
...
export function Map() {
  const [map, setMap] = useState<Maybe<MaplibreMap>>(null)
  ...
  const handleMapLoad = useCallback((event: MapboxEvent) => {
    const map = event.target as unknown as MaplibreMap
